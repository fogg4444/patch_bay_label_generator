# Patch bay layout as physically built BEFORE the 2026-09 reorganization (copied from main).
# generate_html.py compares it with config.py to plan moving whole patch bay units
# instead of flipping normalling cards channel by channel.
